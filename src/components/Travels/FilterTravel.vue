<template>
  ...
  <div class="flex flex-col items-center p-6 ">
          <!-- date -->
    <div class="flex rounded-md shadow-xs pb-5 sm:w-[800px]  w-full justify-center">
      <button v-for="(date, index) in dateOptions" :key="index"
        :class="[
          ' px-10 sm:px-20  py-3 text-md  font-meduim ',
  ...
  <div class="flex items-center justify-between gap-3  flex-col md:flex-row sm:gap-2 w-full max-w-[740px] mx-8 ">
    ...
    <div class="text-md font-normal text-gray-700 flex justify-between items-start ">
      ...
      {{$t('resultat')}}
              ...
              <!-- alert -->
  <div class="pt-5  w-full max-w-[740px] mx-8 ">
