      ...
      <button v-if="payment_accepted.includes('Cash')" class="w-full flex items-center justify-between p-4 rounded-lg border"
        ...
        <div class="flex items-center space-x-4">
          <div class="text-left">
            ...
            <div class="text-sm text-gray-500">{{ $t('appServices.hotel.paidToHotel') }}
            </div>
          </div>
        </div>
        <img
      ...
      <button v-if="payment_accepted.includes('Mobile Money')" class="w-full flex items-center justify-between p-4 rounded-lg border"
        ...
        <div class="flex items-center space-x-4">
          <div class="text-left">
            ...
            <div class="text-sm text-gray-500">Mobile Money
            </div>
          </div>
        </div>
        <img
    ...
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input v-model="postalCode" @blur="validatePostalCode" type="text" :class="['w-full px-3 py-2 border rounded-lg focus:ring-2',
      ...
      <div>
        ...
        <select v-model="country"
          ...
          <option value="United States">{{ $t('countries.united_states') }}</option>
          <option value="Canada">{{ $t('countries.canada') }}</option>
          <option value="United Kingdom">{{ $t('countries.united_kingdom') }}</option>
...
const payment_accepted = hotelStore.this_hotel.paymentMethods;
