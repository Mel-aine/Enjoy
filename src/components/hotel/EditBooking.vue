        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="space-y-2">
              ...
              <input v-model="formData.arrivedDate" type="date"
            ...
            <div class="space-y-2">
              ...
              <input v-model="formData.departDate" type="date"
                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div class="flex gap-4 justify-end">
            ...
            <button type="button" @click="handleCancel"
              class="inline-flex items-center gap-2 px-4 py-2 border bg-gray-500  rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
              {{ $t("cancel")}}
            </button>
          </div>
        </form>
