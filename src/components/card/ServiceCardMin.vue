<template>
  <div
    class="flex flex-col  px-8 shadow-sm rounded-lg overflow-hidden  transition-transform transform hover:scale-105"
  >
    <!-- Image / Carousel -->
    ...
    <div class="flex flex-col justify-between  w-full ">
      <router-link
        :to="search"
        class="mb-1 sm:mb-2 md:mb-1 text-sm md:text-md sm:text-lg lg:text-md line-clamp-1 font-bold tracking-tight"
      >
