      ...
      >
        <div class="p-3" ref="dropdownContentRef">
          ...
          <div  v-show="props.footerDropdown">
            <slot name="footerDrop" > <span class="text-red-500 text-center">No footer element please check this element on your component template name missing !!! </span></slot>
