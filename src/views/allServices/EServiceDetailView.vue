     ...
     <div class="mx-auto">
       ...
       <!-- ajout button -->
         ...
         <div class="border border-gray-200 py-2 px-8 transition-transform duration-300 hover:scale-105 hover:bg-gray-100 rounded-md">
           <button class="flex flex-row items-center space-x-2 text-gray-950 hover:text-red-600">
       ...
       <div class="w-full md:flex md:space-y-0 space-y-4 mb-14 gap-8 my-8 px-8 md:mx-8 lg:mx-8 ">
         ...
         <div class="relative w-full">
           ...
           <button @click="nextSlide" type="button" class="absolute top-1/2 right-0 z-30 flex items-center justify-center h-10 w-10 transform -translate-y-1/2 px-4 cursor-pointer group focus:outline-none" >
             <span  class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
               <svg  class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180"  aria-hidden="true"  xmlns="http://www.w3.org/2000/svg"  fill="none"  viewBox="0 0 6 10">
         ...
         <div class="flex flex-col justify-between  w-full text-start">
           <h3 class="text-xl font-bold text-gray-900 mt-2 mb-1 dark:text-white transition-transform hover:scale-105">
             {{$t('inside')}}
           </h3>
         ...
         <div class="relative w-full">
           ...
           <!-- Slider controls -->
           <button @click="prevSlide2" type="button" class="absolute top-1/2 left-0 z-30 flex items-center justify-center h-10 w-10 transform -translate-y-1/2 px-4 cursor-pointer group focus:outline-none">
             <span  class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
               <svg  class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180"  aria-hidden="true"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10" >
                 <path  stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"  d="M5 1 1 5l4 4" />
               </svg>
           ...
           <button @click="nextSlide2" type="button" class="absolute top-1/2 right-0 z-30 flex items-center justify-center h-10 w-10 transform -translate-y-1/2 px-4 cursor-pointer group focus:outline-none" >
             <span  class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
               <svg  class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180"  aria-hidden="true"  xmlns="http://www.w3.org/2000/svg"  fill="none"  viewBox="0 0 6 10">
                 <path  stroke="currentColor"  stroke-linecap="round"  stroke-linejoin="round"  stroke-width="2"  d="m1 9 4-4-4-4" />
               </svg>
         ...
         <div class="flex flex-col justify-between  w-full text-start">
           ...
           <div class="mt-4 ">
             <span class="text-md font-normal text-gray-600 flex flex-row gap-2">
               <svg width="24" height="24" class="icon_svg"><path d="M20.2 15.57a12.21 12.21 0 0 0-2.32-4.87l2.7-2.7h1.15a1 1 0 1 0 0-2H17.5a1 1 0 0 0 0 2h.25l-1.23 1.23A12.17 12.17 0 0 0 9 6V2a1 1 0 0 0-1-1H5a1 1 0 0 0 0 2h2v6.08a7 7 0 1 0 2 0V8a10.25 10.25 0 0 1 9.18 7.72 3.74 3.74 0 1 0 2-.18l.02.03ZM13 16a5 5 0 1 1-6-4.9V16a1 1 0 1 0 2 0v-4.9a5 5 0 0 1 4 4.9Zm6.5 5a1.75 1.75 0 0 1-1-3.17v1.67a1 1 0 1 0 2 0v-1.7a1.75 1.75 0 0 1-1 3.2Z"></path></svg>
              {{$t('hipster')}}
             </span>
           </div>
           <div class="mt-3 ">
             <span class="text-md font-normal text-gray-600 flex flex-row gap-2">
               <svg width="24" height="24" class="icon_svg"><path d="M22 6h-4.65a3 3 0 0 1-2.74-1.77l-1.18-2.64a1 1 0 0 0-.91-.59H6.1A5.11 5.11 0 0 0 1 6.1V13a5 5 0 0 0 5 5h6.3a3 3 0 0 0-.78 2A3 3 0 1 0 15 17.05v-1.14c1.9-.26 6-1.31 7.91-5.5A1 1 0 0 0 23 10V7a1 1 0 0 0-1-1Zm-6.5 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM21 9.78C19 13.84 14.19 14 14 14a1 1 0 0 0-1 1v1h-3c.076-.1.146-.203.21-.31a4.94 4.94 0 0 0 .31-4.78l-2.36-5a1 1 0 0 0-1.36-.53 1 1 0 0 0-.48 1.33l2.36 5A3 3 0 1 1 3 13V6.1A3.1 3.1 0 0 1 6.1 3h5.77l.92 2a5 5 0 0 0 4.56 3H21v1.78Z"></path></svg>
               {{$t('dog_allow')}}
             </span>
           </div>
         </div>
         ...
         <div class="relative w-full">
           <!-- Carousel wrapper -->
           <div class="relative h-[150px] overflow-hidden rounded-t-lg">
             <div class="flex transition-transform duration-500 ease-in-out" :style="{ transform: 'translateX(' + -currentIndex1 * 100 + '%)' }" >
               <div v-for="(img, index) in images" :key="index" class="w-full flex-shrink-0">
                 <img :src="img" alt="Menu Item" class="object-cover w-full h-48 md:h-40 lg:h-48 rounded-t-lg transform hover:scale-105 transition-transform duration-300" />
               </div>
             </div>
           ...
           <!-- Slider controls -->
           <button @click="prevSlide1" type="button" class="absolute top-1/2 left-0 z-30 flex items-center justify-center h-10 w-10 transform -translate-y-1/2 px-4 cursor-pointer group focus:outline-none">
             <span  class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
               <svg  class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180"  aria-hidden="true"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10" >
                 <path  stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"  d="M5 1 1 5l4 4" />
               </svg>
           ...
           <button @click="nextSlide1" type="button" class="absolute top-1/2 right-0 z-30 flex items-center justify-center h-10 w-10 transform -translate-y-1/2 px-4 cursor-pointer group focus:outline-none" >
             <span  class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
               <svg  class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180"  aria-hidden="true"  xmlns="http://www.w3.org/2000/svg"  fill="none"  viewBox="0 0 6 10">
                 <path  stroke="currentColor"  stroke-linecap="round"  stroke-linejoin="round"  stroke-width="2"  d="m1 9 4-4-4-4" />
               </svg>
         ...
         <div class="flex flex-col justify-between  w-full text-start">
           ...
           <div class="mt-4 ">
             <span class="text-md font-normal text-gray-600 flex flex-row gap-2">
               <svg width="24" height="24" class="icon_svg"><path d="M22.129 11.22a11.45 11.45 0 0 0-3.24-1.77 4.497 4.497 0 0 0 .5-2.046V6.007a4.512 4.512 0 0 0-7.398-3.47 1 1 0 0 0 1.28 1.537 2.513 2.513 0 0 1 4.118 1.933v1.397a2.513 2.513 0 0 1-1.495 2.298 1 1 0 0 0 .808 1.83c.262-.119.511-.263.745-.43a9.516 9.516 0 0 1 3.445 1.69.597.597 0 0 1 0 .93c-.283.223-.925.635-1.149.774a1 1 0 0 0 1.059 1.697c.092-.057.908-.568 1.327-.898a2.596 2.596 0 0 0 0-4.074Z"></path><path d="M17.624 15.54a12.423 12.423 0 0 0-3.438-1.901 4.786 4.786 0 0 0 .418-1.947V9.784a4.829 4.829 0 0 0-9.658 0v1.908c.002.672.144 1.337.42 1.95a12.264 12.264 0 0 0-3.442 1.898 2.742 2.742 0 0 0 0 4.298 12.722 12.722 0 0 0 7.85 2.668 12.716 12.716 0 0 0 7.85-2.668 2.742 2.742 0 0 0 0-4.299ZM6.946 9.783a2.829 2.829 0 0 1 5.658 0v1.908a2.828 2.828 0 1 1-5.658 0V9.784Zm9.44 8.483a10.707 10.707 0 0 1-6.612 2.239 10.717 10.717 0 0 1-6.613-2.24.74.74 0 0 1 .001-1.156 10.327 10.327 0 0 1 3.476-1.776 4.735 4.735 0 0 0 6.27.003c1.26.367 2.44.97 3.479 1.773a.74.74 0 0 1 0 1.157Z"></path></svg>
              {{$t('good_for_group')}}
             </span>
           </div>
           <div class="mt-3 ">
             <span class="text-md font-normal text-gray-600 flex flex-row gap-2">
               <svg width="24" height="24" class="icon_svg"><path d="M20.92 17.16a.56.56 0 0 0-.05-.08L5.54 1.75A2.57 2.57 0 1 0 1.9 5.38l.74.74a1 1 0 0 0 1.41-1.41L3.31 4a.573.573 0 0 1 .81-.81L7 6v7a4 4 0 0 0 .83 2.42l-1 1A3.59 3.59 0 0 0 5.16 16a3.5 3.5 0 1 0 3.5 3.5 3.41 3.41 0 0 0-.43-1.65l1.18-1.18A4 4 0 0 0 11 17h7l.46.46a3 3 0 1 0 2.5-.3h-.04ZM5.16 21a1.5 1.5 0 1 1 1.06-2.56A1.51 1.51 0 0 1 5.16 21ZM11 15a2 2 0 0 1-2-2V8l7 7h-5Zm9 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>
               {{$t('good_for_kid')}}
             </span>
           </div>
         </div>
       ...
       <div>
             <div class="lg:p-3 bg-white lg:px-8 " v-if="item.opening_hours">
 ...
 <ModalCategory :isOpen = "isModalOpen" @close="isModalOpen=false" :title="'What’s your relationship to this business?'" :showActionButton="true"
  ...
  <div class="min-h-screen bg-white">
      ...
      <div
        ...
        <div class="flex items-center mb-4 sm:mb-3 md:mb-4 space-x-1">
          <span v-for="star in 5" :key="star" class="">
            <svg v-if="star <= rating" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex flex-row gap-2 mb-2 items-center">
          <span class="flex flex-row gap-2 items-center text-ellipsis text-purple-800 font-semibold text-md">
            ...
            </svg> {{ $t('claimed') }} </span>. FCFA . <a href="#" class="hover:underline font-semibold">Fast Food</a>,
          <a href="#" class="hover:underline font-semibold">Burger</a>
        </div>
        <div class="mb-5"><span class="text-green-500">{{ $t('open') }}</span> <span class="font-semibold text-md">11:00
            AM - 03:00 AM ({{ $t('next_day') }})</span>
          <button
    ...
    <div class="max-w-screen-2xl lg:flex-row justify-between flex-col mx-auto md:px-4 lg:px-16 mt-20" :class="{ 'hidden': search }">
      <div class="mx-auto">
        <div
          class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4  md:space-y-0 space-y-4  mt-40 mb-7 space-x-2 items-center sm:px-8 mx-8 md:mt-10 lg:mt-10 ">
          <!-- ajout button -->
          <div
    ...
    <!-- <div :class="{ 'hidden': !search }" class="mt-12">
  ...
  <ModalCategory :isOpen="isModalOpen" @close="isModalOpen = false" :title="'What’s your relationship to this business?'"
    ...
    <div class="mt-5 space-y-4">
      ...
      <div class="flex items-center  p-3 border-b border-gray-200 me-4">
        <input id="orange-radio" type="radio" value="" name="colored-radio"
          class="w-4 h-4 text-orange-500 bg-gray-100 border-gray-300 focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <label for="orange-radio" class="ms-2 text-md font-normal text-gray-900 dark:text-gray-300">I work at this
          business</label>
      </div>
      <div class="flex items-center  p-3 border-b border-gray-200 me-4">
        <input id="orange-radio" type="radio" value="" name="colored-radio"
          class="w-4 h-4 text-orange-500 bg-gray-100 border-gray-300 focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <label for="orange-radio" class="ms-2 text-md font-normal text-gray-900 dark:text-gray-300">I’m a
          customer</label>
      </div>
    </div>
