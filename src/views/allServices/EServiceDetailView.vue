<template>
 ...
 <div v-for="item in filteredPlaces" :key="item.id"  class="min-h-screen bg-white">
  ...
  <div class="relative w-full h-[620px] top-0 overflow-hidden ">
    ...
    <div class="absolute top-[72%] left-[22%] transform -translate-x-1/2 -translate-y-1/2 text-white p-5 sm:mx-0 mx-24  w-1/3">
  ...
  <div class="flex lg:flex-row justify-between flex-col mx-auto px-8 mt-20">
        ...
        <div class="relative w-full">
          ...
          <div class="relative h-[150px] overflow-hidden rounded-t-lg">
            <div class="flex transition-transform duration-500 ease-in-out" :style="{ transform: 'translateX(' + -currentIndex * 100 + '%)' }" >
              <div v-for="(img, index) in images1" :key="index" class="w-full flex-shrink-0">
    ...
    <!-- suggestion component -->
      <InfoService :email=item.email :phone=item.phone :address=item.address :localisation=item.location></InfoService>
  </div>
</div>
</div>
<!-- modal -->
