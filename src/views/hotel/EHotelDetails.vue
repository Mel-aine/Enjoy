                ...
                <div class="flex items-center mb-4 space-x-1">
                    <span v-for="star in 5" :key="star">
                        ...
                        <svg v-else xmlns="http://www.w3.org/2000/svg"
                            class="w-6 h-6 fill-white p-1 rounded-md bg-white/25" viewBox="0 0 24 24">
                            <path
                                d="M12 2l2.58 7.95H22l-6.29 4.74 2.58 7.95-6.29-4.74-6.29 4.74 2.58-7.95L2 9.95h7.42L12 2z" />
                        </svg>
                    </span>
                ...
                <div
                    ...
                    <div
                        ...
                        <button class="flex items-center space-x-2 text-white font-medium text-md" type="button">
                            <svg class="h-7 w-7" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
            ...
            <div class="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto" @click.stop>
                <div class="relative">
                    ...
                    <div class="relative h-96">
                        <img :src="images[currentImageIndex]" :alt="selectedRoom.productName"
                                ...
                                <div class="bg-gray-50 p-6 rounded-lg">
                                    <div class="grid grid-cols-2 gap-4 mb-6">
                                        <div class="text-center">
                                            <svg class="w-6 h-6 mx-auto text-gray-400 mb-2" fill="currentColor"
                                                viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
